      ...
      <div className="max-w-lg mx-auto">
        <div className="mb-6">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="bg-blue-900 text-white px-4 py-2 rounded-xl font-semibold text-sm hover:bg-blue-800 active:bg-blue-950 transition-colors"
            >
              + Add Product
            </Link>
          </div>
        ...
        {products.length === 0 ? (
          <div className="bg-white rounded-3xl shadow-sm border border-sky-100 p-8 text-center">
            ...
            <p className="text-blue-700 font-medium">No products yet</p>
            <p className="text-sm text-sky-500 mt-1">Add your first product to get started</p>
          </div>
        ) : (
